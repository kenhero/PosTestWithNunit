...
namespace FiscalDocument.Library
{
    public class FiscalDocument
    {
        ...
        public FiscalDocument(string printerName)
        {
            try
            {
        ...
        public int testFiscalDocumentClass(string printerName)
        {
            try
            {
                ...
                //Console.WriteLine("Printer is RT model");
                ...
                // Fiscal document
                Console.WriteLine("Performing beginFiscalDocument() method ");
                if (fiscalprinter.CapSlpFiscalDocument)
                {
                    fiscalprinter.BeginFiscalDocument((Int32)500);
